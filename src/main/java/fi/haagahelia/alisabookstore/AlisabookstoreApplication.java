...
public class AlisabookstoreApplication {
	...
	public CommandLineRunner bookDemo(BookRepository repository, CategoryRepository crepository,
		...
		return (args) -> {
			...
			// repository.save(new Book("Beautiful evening", "Tom Tomson", 2020, "56678934",
			// 20, category1));
			// repository.save(new Book("Life in Finland", "Ankka Kerilainen", 2018,
			// "38895503", 90, category2));
			// repository.save(new Book("City of Helsinki", "Musta Lakkonen", 2013,
			// "49902022", 76, category3));
